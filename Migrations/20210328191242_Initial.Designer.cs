...
namespace Bowling.Migrations
{
    ...
    [Migration("20210328191242_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bowling.Models.BowlerScores", b =>
                {
            ...
            modelBuilder.Entity("Bowling.Models.Bowlers", b =>
                {
                    b.Property<long>("BowlerId")
                        .HasColumnName("BowlerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bowling.Models.MatchGames", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnName("MatchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bowling.Models.Teams", b =>
                {
                    b.Property<long>("TeamId")
                        .HasColumnName("TeamID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bowling.Models.Tournaments", b =>
                {
            ...
            modelBuilder.Entity("Bowling.Models.TourneyMatches", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnName("MatchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bowling.Models.ZtblBowlerRatings", b =>
                {
            ...
            modelBuilder.Entity("Bowling.Models.ZtblSkipLabels", b =>
                {
            ...
            modelBuilder.Entity("Bowling.Models.ZtblWeeks", b =>
                {
            ...
            modelBuilder.Entity("Bowling.Models.BowlerScores", b =>
                {
                    b.HasOne("Bowling.Models.Bowlers", "Bowler")
            ...
            modelBuilder.Entity("Bowling.Models.Bowlers", b =>
                {
                    b.HasOne("Bowling.Models.Teams", "Team")
                        .WithMany("Bowlers")
            ...
            modelBuilder.Entity("Bowling.Models.MatchGames", b =>
                {
                    b.HasOne("Bowling.Models.TourneyMatches", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("Bowling.Models.TourneyMatches", b =>
                {
                    b.HasOne("Bowling.Models.Teams", "EvenLaneTeam")
                        .WithMany("TourneyMatchesEvenLaneTeam")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("Bowling.Models.Teams", "OddLaneTeam")
                        .WithMany("TourneyMatchesOddLaneTeam")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("Bowling.Models.Tournaments", "Tourney")
